...
const COMMUNITY_LINK = 'https://chat.whatsapp.com/ElCt7BWby5dLVyBR88QSMt';
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#f2faf5', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 24px 48px' }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .ss-sub strong { color: #1a1208; font-weight: 600; }
        ...
        .ss-btn { display: flex; align-items: center; justify-content: center; gap: 10px; width: 100%; padding: 14px 24px; font-family: 'DM Sans', sans-serif; font-size: 0.88rem; font-weight: 600; border: none; border-radius: 8px; cursor: pointer; text-decoration: none; transition: all 0.2s; }
      ...
      <div className="ss-card">
        ...
        <a href={COMMUNITY_LINK} target="_blank" rel="noopener noreferrer" className="ss-btn ss-btn-green">
