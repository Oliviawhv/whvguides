          ...
          {status !== 'success' && (
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input id="cs-email" className="cs-input" type="email" autoComplete="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="The email you subscribed with" />
