    ...
    <main style={{ background: '#f2faf5', color: '#1a1208', fontFamily: "'DM Sans', sans-serif", minHeight: '100vh' }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* HERO */
        .hero { position: relative; min-height: 100vh; display: flex; flex-direction: column; justify-content: flex-end; overflow: hidden; background: #1a6e3a; }
        .hero-bg { position: absolute; inset: 0; background: url('/hero-beach.jpeg') center 85% / cover no-repeat; animation: kenburns 20s ease-in-out infinite alternate; will-change: transform; filter: brightness(0.70); }
        @keyframes kenburns { from { transform: scale(1); } to { transform: scale(1.06); } }
        .hero-scrim { position: absolute; inset: 0; background: linear-gradient(to top, rgba(26,158,82,0.23) 0%, rgba(26,158,82,0.15) 50%, rgba(26,158,82,0.10) 100%); }
