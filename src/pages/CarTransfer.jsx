...
export default function CarTransfer() {
  ...
  const faqs = [
    { q: 'Where do your drivers come from?', a: 'We run a community of over 1,600 Working Holiday Visa backpackers, organized into 30+ groups covering every region of the country. Every driver is part of our verified network, allowing us to quickly connect you with reliable, available drivers wherever you need them.' },
    ...
    <>
      ...
      <div style={{ fontFamily: '-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', color: '#0F172A', margin: 0, padding: 0 }}>
        ...
        <div id="contact" className="section-pad" style={{ padding: '1.75rem 2rem', background: LIGHT }}>
          ...
          <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, maxWidth: 780, margin: '0 auto' }}>
            ...
            <div style={{ background: '#fff', border: `1.5px solid ${BORDER}`, borderRadius: 14, padding: '1.25rem', display: 'flex', gap: 12 }}>
              <div style={{ width: 42, height: 42, minWidth: 42, background: NAVY, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="#86EFAC"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.77a4.85 4.85 0 01-1.01-.08z"/></svg>
              </div>
              <div>
                <div style={{ fontSize: 10, color: '#94A3B8', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.07em', marginBottom: 3 }}>TikTok</div>
                <a href="https://www.tiktok.com/@whvguides" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, fontWeight: 700, color: '#0F172A', textDecoration: 'none' }}>@whvguides</a>
                <div style={{ fontSize: 11, color: '#94A3B8', marginTop: 2 }}>13K+ WHV followers</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: NAVY, padding: '2rem 2rem 1rem' }}>
          ...
          <div className="footer-desktop-only" style={{ maxWidth: 900, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem', paddingBottom: '1.5rem', borderBottom: '1px solid rgba(255,255,255,.08)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 200 }}>
              ...
              <p style={{ fontSize: 12, color: 'rgba(255,255,255,.4)', lineHeight: 1.5, margin: 0 }}>Australia-wide vehicle relocation. 24 hours a day, 7 days a week.</p>
            </div>
            <div>
